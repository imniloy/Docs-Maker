        ...
        <div className="space-x-5 flex">
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="px-4 py-2 border border-[#202124] hover:border-[#4285F4]  mx-auto max-w-[250px] font-semibold text-center cursor-pointer rounded-[36px] w-full hover:text-[#4285F4] ">
                Manage Your Account
              </div>
